...
def sourceRepository : String := "automorphism-groups-cn-affine-canonical-lane"
def sourceDescription : String := "Automorphism Groups of Complex Affine Spaces"
...
def sourceTheoremBoundary : ClassicalBoundary := {
  claimBoundary := "classical boundary carried by theorem boundary open"
}
